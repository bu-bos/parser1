    ...
    if c == 0:
        ...
        for item in kk_items:
            ...
            if item.find(class_='card-item__display-title') != None:
                    ...
                    if item.find(class_='prev') != None:
                        full_cost_kk = item.find(class_='prev').text
                        print('Полная стоимость:' + full_cost_kk)
                        lower_price_kk = item.find(class_='curr').text
                        print('Сниженная стоимость:' + lower_price_kk)


                    else: 
                        cost_kk = item.find(class_='curr').text
                        print('Полная стоимость:' + cost_kk)
            ...
            for item in a_items:
                ...
                if item.find(class_='card-item__display-title') != None:
                    ...
                    if item.find(class_='prev') != None:
                        ...
                        print('Полная стоимость:' + full_cost_a)
                        lower_price_a = item.find(class_='curr').text
                        print('Сниженная стоимость:' + lower_price_a)
                    else: 
                        cost_a = item.find(class_='curr').text
                        print('Полная стоимость:' + cost_a)
        ...
        for item in m_items:
            ...
            if item.find(class_='prev') != None:
                ...
                print('Полная стоимость:' + full_cost_m)
                lower_price_m = item.find(class_='curr').text
                print('Сниженная стоимость:' + lower_price_m)


            else: 
                cost_m = item.find(class_='curr').text
                print('Полная стоимость:' + cost_m)
        ...
        for item in s_items:
            ...
            if item.find(class_='prev') != None:
                ...
                print('Полная стоимость:' + full_cost_s)
                lower_price_s = item.find(class_='curr').text
                print('Сниженная стоимость:' + lower_price_s)


            else: 
                cost_s = item.find(class_='curr').text
                print('Полная стоимость:' + cost_s)
